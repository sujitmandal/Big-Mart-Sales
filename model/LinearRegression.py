...
if not os.path.exists('plot/LinearRegression'):
    os.mkdir('plot/LinearRegression')
...
def linearRegression(train, test):
    ...
    plt.grid(True)
    plt.savefig('plot/LinearRegression/plot1.pdf')
    ...
    plt.grid(True)
    plt.plot(lims, lims)
    plt.savefig('plot/LinearRegression/plot2.pdf')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
    ...
    _ = plt.ylabel("Count")
    plt.savefig('plot/LinearRegression/plot3.pdf')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
    ...
    plt.ylabel('Item Outlet Sales')
    plt.grid(True)
    plt.savefig('plot/LinearRegression/plot4.pdf')
    plt.show(block=False)
    plt.pause(5)
    plt.close()
